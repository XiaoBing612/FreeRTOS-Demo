...
#define configMAX_PRIORITIES		( 5 )																	/* 可供用户定义的最大优先级数 */
...
#define configUSE_TRACE_FACILITY	0																		/* 添加额外的结构体成员和函数，以此来协助可视化和跟踪 */
#define configUSE_16_BIT_TICKS		0																		/* 32位的内核配置为0 */
#define configIDLE_SHOULD_YIELD		1																		/* 使能抢占式调度器 */
